...
const FLAVORNET_DATABASE: Record<string, FlavornetData> = {
  ...
  // === NOUVEAUX COMPOSÉS - SESSION 5 ===
  '79-92-5': { casNumber: '79-92-5', name: 'camphene', molecularWeight: 136.2, percepts: ['camphor', 'woody', 'herbal'], kovatsRI: { DB5: 946 }, source: 'flavornet' },
  // Sesquiterpènes supplémentaires
  '489-40-7': { casNumber: '489-40-7', name: 'guaiol', molecularWeight: 222.4, percepts: ['woody', 'rose', 'tea'], kovatsRI: { DB5: 1600 }, source: 'flavornet' },
  '5937-11-1': { casNumber: '5937-11-1', name: 'alpha-eudesmol', molecularWeight: 222.4, percepts: ['woody', 'sweet', 'floral'], kovatsRI: { DB5: 1652 }, source: 'flavornet' },
  '473-15-4': { casNumber: '473-15-4', name: 'beta-eudesmol', molecularWeight: 222.4, percepts: ['woody', 'sweet', 'herbal'], kovatsRI: { DB5: 1649 }, source: 'flavornet' },
  '1139-30-6': { casNumber: '1139-30-6', name: 'caryophyllene oxide', molecularWeight: 220.4, percepts: ['woody', 'spicy', 'dry'], kovatsRI: { DB5: 1583 }, source: 'flavornet' },
  '495-60-3': { casNumber: '495-60-3', name: 'zingiberene', molecularWeight: 204.4, percepts: ['ginger', 'citrus', 'woody'], kovatsRI: { DB5: 1495 }, source: 'flavornet' },
  '17066-67-0': { casNumber: '17066-67-0', name: 'gamma-muurolene', molecularWeight: 204.4, percepts: ['woody', 'herbal', 'spicy'], kovatsRI: { DB5: 1479 }, source: 'flavornet' },
  '30021-74-0': { casNumber: '30021-74-0', name: 'gamma-cadinene', molecularWeight: 204.4, percepts: ['woody', 'herbal', 'thyme'], kovatsRI: { DB5: 1513 }, source: 'flavornet' },
  '483-76-1': { casNumber: '483-76-1', name: 'delta-cadinene', molecularWeight: 204.4, percepts: ['woody', 'herbal', 'thyme'], kovatsRI: { DB5: 1523 }, source: 'flavornet' },
  // Alcools terpéniques
  '7212-44-4': { casNumber: '7212-44-4', name: 'nerolidol', molecularWeight: 222.4, percepts: ['floral', 'woody', 'waxy'], kovatsRI: { DB5: 1564 }, source: 'flavornet' },
  '40716-66-3': { casNumber: '40716-66-3', name: 'elemol', molecularWeight: 222.4, percepts: ['woody', 'dry', 'balsamic'], kovatsRI: { DB5: 1549 }, source: 'flavornet' },
  '639-99-6': { casNumber: '639-99-6', name: 'spathulenol', molecularWeight: 220.4, percepts: ['herbal', 'fruity', 'woody'], kovatsRI: { DB5: 1578 }, source: 'flavornet' },
  '502-61-4': { casNumber: '502-61-4', name: 'alpha-farnesene', molecularWeight: 204.4, percepts: ['woody', 'citrus', 'green apple'], kovatsRI: { DB5: 1508 }, source: 'flavornet' },
  '18794-84-8': { casNumber: '18794-84-8', name: 'beta-farnesene', molecularWeight: 204.4, percepts: ['woody', 'citrus', 'green'], kovatsRI: { DB5: 1458 }, source: 'flavornet' },
  // Aldéhydes supplémentaires
  '4440-65-7': { casNumber: '4440-65-7', name: '2-nonenal', molecularWeight: 140.2, percepts: ['fatty', 'cucumber', 'green'], kovatsRI: { DB5: 1157 }, source: 'flavornet' },
  '2463-53-8': { casNumber: '2463-53-8', name: '2-octenal', molecularWeight: 126.2, percepts: ['fatty', 'nutty', 'green'], kovatsRI: { DB5: 1055 }, source: 'flavornet' },
  // Cétones
  // Esters supplémentaires
  '109-60-4': { casNumber: '109-60-4', name: 'propyl acetate', molecularWeight: 102.1, percepts: ['fruity', 'pear', 'solvent'], kovatsRI: { DB5: 712 }, source: 'flavornet' },
  '628-63-7': { casNumber: '628-63-7', name: 'amyl acetate', molecularWeight: 130.2, percepts: ['fruity', 'banana', 'pear'], kovatsRI: { DB5: 913 }, source: 'flavornet' },
  '112-06-1': { casNumber: '112-06-1', name: 'heptyl acetate', molecularWeight: 158.2, percepts: ['fruity', 'green', 'herbal'], kovatsRI: { DB5: 1113 }, source: 'flavornet' },
  '112-14-1': { casNumber: '112-14-1', name: 'octyl acetate', molecularWeight: 172.3, percepts: ['fruity', 'floral', 'waxy'], kovatsRI: { DB5: 1213 }, source: 'flavornet' },
  // Alcools
  '928-96-1': { casNumber: '928-96-1', name: 'cis-3-hexenol', molecularWeight: 100.2, percepts: ['green', 'leafy', 'fresh'], kovatsRI: { DB5: 857 }, source: 'flavornet' },
  '544-12-7': { casNumber: '544-12-7', name: 'cis-3-hexenal', molecularWeight: 98.1, percepts: ['green', 'leafy', 'grassy'], kovatsRI: { DB5: 797 }, source: 'flavornet' },
  // Composés aromatiques
  '100-42-5': { casNumber: '100-42-5', name: 'styrene', molecularWeight: 104.2, percepts: ['balsamic', 'floral', 'plastic'], kovatsRI: { DB5: 893 }, source: 'flavornet' },
  '98-86-2': { casNumber: '98-86-2', name: 'acetophenone', molecularWeight: 120.2, percepts: ['floral', 'almond', 'cherry'], kovatsRI: { DB5: 1065 }, source: 'flavornet' },
  '122-78-1': { casNumber: '122-78-1', name: 'phenylacetaldehyde', molecularWeight: 120.2, percepts: ['honey', 'floral', 'hyacinth'], kovatsRI: { DB5: 1042 }, source: 'flavornet' },
  '103-45-7': { casNumber: '103-45-7', name: 'phenethyl acetate', molecularWeight: 164.2, percepts: ['floral', 'rose', 'honey'], kovatsRI: { DB5: 1255 }, source: 'flavornet' },
  // Phénylpropanoïdes
  '93-28-7': { casNumber: '93-28-7', name: 'eugenyl acetate', molecularWeight: 206.2, percepts: ['clove', 'spicy', 'floral'], kovatsRI: { DB5: 1525 }, source: 'flavornet' },
  '4180-23-8': { casNumber: '4180-23-8', name: 'trans-anethole', molecularWeight: 148.2, percepts: ['anise', 'sweet', 'licorice'], kovatsRI: { DB5: 1283 }, source: 'flavornet' },
  '140-67-0': { casNumber: '140-67-0', name: 'estragole', molecularWeight: 148.2, percepts: ['anise', 'sweet', 'herbal'], kovatsRI: { DB5: 1196 }, source: 'flavornet' },
  '93-15-2': { casNumber: '93-15-2', name: 'methyl eugenol', molecularWeight: 178.2, percepts: ['clove', 'spicy', 'cinnamon'], kovatsRI: { DB5: 1403 }, source: 'flavornet' },
  // Composés soufrés supplémentaires
  // Pyrazines supplémentaires
  '18138-04-0': { casNumber: '18138-04-0', name: '2-ethyl-3,6-dimethylpyrazine', molecularWeight: 136.2, percepts: ['nutty', 'potato', 'roasted'], kovatsRI: { DB5: 1085 }, source: 'flavornet' },
  // Furanones
  '118-71-8': { casNumber: '118-71-8', name: 'maltol', molecularWeight: 126.1, percepts: ['caramel', 'cotton candy', 'sweet'], kovatsRI: { DB5: 1110 }, source: 'flavornet' },
  // Diterpènes et autres
  '17092-92-1': { casNumber: '17092-92-1', name: 'sclareol', molecularWeight: 308.5, percepts: ['amber', 'tobacco', 'balsamic'], kovatsRI: { DB5: 2220 }, source: 'flavornet' },
  '127-51-5': { casNumber: '127-51-5', name: 'alpha-isomethyl ionone', molecularWeight: 206.3, percepts: ['violet', 'woody', 'powdery'], kovatsRI: { DB5: 1520 }, source: 'flavornet' },
  '79-69-6': { casNumber: '79-69-6', name: 'isophorone', molecularWeight: 138.2, percepts: ['minty', 'camphor', 'peppermint'], kovatsRI: { DB5: 1120 }, source: 'flavornet' },
  // Acides
