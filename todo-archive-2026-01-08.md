...
### Pack Heritage & Conservation (34 références)
- [x] Analyser la structure du pack Heritage & Conservation
...
## 🔧 SESSION 08 JAN 2026 - PAGES ADMIN MANQUANTES

### Phase 1 : Créer les pages d'administration manquantes
- [ ] Créer la page /admin/molecules (liste complète avec édition inline)
- [ ] Créer la page /admin/accords (gestion des accords olfactifs)
- [ ] Créer la page /admin/familles (gestion des familles olfactives)
- [ ] Créer la page /admin/matieres (gestion des matières premières)

### Phase 2 : Mise à jour du hub admin
- [ ] Corriger les liens cassés dans le hub /admin
- [ ] Ajouter la navigation entre les pages admin
- [ ] Tester tous les liens du hub admin
...
## 🚨 SESSION 08 JAN 2026 - PROBLÈMES CRITIQUES À RÉSOUDRE

### CRITIQUE P0 : Interface Contributeur pour les 5 collègues
- [ ] Créer le formulaire d'ajout de molécule avec recherche de doublons
- [ ] Créer le formulaire d'ajout de plante avec recherche de doublons
- [ ] Créer l'interface de création de liaisons (molécule↔recette, molécule↔plante, plante↔terroir)
- [ ] Implémenter la recherche automatique de doublons avant création

### CRITIQUE P0 : Améliorer les liaisons entre entités
- [ ] Auditer les liaisons existantes (molécule→recette: 19%, molécule→plante: 0.2%, plante→terroir: 8%)
- [ ] Créer une interface drag-drop pour créer des liaisons rapidement
- [ ] Permettre la création de liaisons en masse via CSV

### IMPORTANT P1 : Système de brouillons et validation
- [ ] Ajouter un champ "status" (brouillon/validé) aux entités
- [ ] Créer l'interface de validation admin
- [ ] Implémenter les notifications admin pour les nouvelles contributions

### IMPORTANT P1 : Import CSV amélioré
...
### DETTE TECHNIQUE : Nettoyage du projet
- [ ] Auditer et nettoyer le fichier todo.md (70+ sessions, numérotation incohérente)
- [ ] Compléter les pages admin manquantes (/admin/molecules, /admin/accords, /admin/familles, /admin/matieres)
- [ ] Vérifier les fonctionnalités annoncées vs implémentées
- [ ] Documenter l'état réel du projet

### Statistiques de qualité des données à améliorer
