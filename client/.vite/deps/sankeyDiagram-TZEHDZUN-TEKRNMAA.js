...
// node_modules/.pnpm/mermaid@11.12.2/node_modules/mermaid/dist/chunks/mermaid.core/sankeyDiagram-TZEHDZUN.mjs
var parser = (function() {
...
var addLink = __name((source, target, value) => {
...
var draw = __name(function(text, id, _version, diagObj) {
  ...
  const getText = __name(({ id: id2, value }) => {
    if (!showValues) {
      return id2;
    }
    return `${id2}
...
//# sourceMappingURL=sankeyDiagram-TZEHDZUN-TEKRNMAA.js.map
