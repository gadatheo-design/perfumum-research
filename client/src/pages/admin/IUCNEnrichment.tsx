...
export default function IUCNEnrichment() {
  ...
  return (
    <div className="min-h-screen bg-background p-8">
      <div className="max-w-4xl mx-auto">
        <div className="mb-8">
          <h1 className="text-3xl font-bold mb-2">🛡️ IUCN Enrichment</h1>
          <p className="text-muted-foreground">Red List of Threatened Species</p>
        </div>
        ...
        <Tabs defaultValue="search" className="w-full">
          ...
          <TabsContent value="stats" className="space-y-4">
            <Card>
              <CardHeader>
                <CardTitle>IUCN Statistics</CardTitle>
              </CardHeader>
              <CardContent>
                {statsMutation.data && (
                  <div className="space-y-2">
                    <p className="text-sm"><strong>Species:</strong> {statsMutation.data.coverage?.species}</p>
                    <p className="text-sm"><strong>Assessments:</strong> {statsMutation.data.coverage?.assessments}</p>
                  </div>
                )}
              </CardContent>
            </Card>
