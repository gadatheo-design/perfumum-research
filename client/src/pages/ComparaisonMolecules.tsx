...
export default function ComparaisonMolecules() {
  ...
  const getCharacteristics = (moleculeId: number) => {
    ...
    return [
      ...
      { characteristic: 'Intensité', value: Math.random() * 100 }, // Placeholder
      { characteristic: 'Volatilité', value: Math.random() * 100 }, // Placeholder
      { characteristic: 'Complexité', value: Math.random() * 100 }, // Placeholder
    ];
  };
