...
interface RecetteSynergyEntry {
  id: number;
  recetteId: number;
  recetteName?: string | null;
  coMoleculeId?: number | null;
  coMoleculeName?: string | null;
  coOccurrenceCount?: number | null;
  avgProportion?: number | null;
}

interface RecetteSynergiesSectionProps {
  moleculeId: number;
  moleculeName: string;
}
