...
const routeConfig: Record<string, { label: string; parent?: string }> = {
  ...
  "/atlas": { label: "Atlas Olfactif", parent: "/storylines" },
  ...
  "/phylogenetique": { label: "Phylogénétique", parent: "/plantes" },
  "/nicotiana-explorer": { label: "Explorateur Nicotiana", parent: "/phylogenetique" },
  "/classification-phylogenetique": { label: "Classification Détaillée", parent: "/phylogenetique" },
